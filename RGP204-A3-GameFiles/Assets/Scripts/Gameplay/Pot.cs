...
{   
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (other.CompareTag("Seed"))
        {
            ...
            {
                plant.seedType = SeedType.Normal; // Assign the seed type
    ...
    private void AssignRandomSeedling(Plant plant)
    {
        ...
        {
            case 1:
                plant.seedlingSprite = plant.normalSeedling1;
                plant.seedlingWitheredSprite = plant.normalSeedlingWithered1;
                break;
            case 2:
                plant.seedlingSprite = plant.normalSeedling2;
                plant.seedlingWitheredSprite = plant.normalSeedlingWithered2;
                break;
            case 3:
                plant.seedlingSprite = plant.normalSeedling3;
                plant.seedlingWitheredSprite = plant.normalSeedlingWithered3;
                break;
            case 4:
                plant.seedlingSprite = plant.normalSeedling4;
                plant.seedlingWitheredSprite = plant.normalSeedlingWithered4;
                break;
            case 5:
                plant.seedlingSprite = plant.normalSeedling5;
                plant.seedlingWitheredSprite = plant.normalSeedlingWithered5;
                break;
        }
